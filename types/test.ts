...
const sig = StellarSdk.xdr.DecoratedSignature.fromXDR(BrowserBuffer.of(1, 2)); // $ExpectType DecoratedSignature
sig.hint(); // $ExpectType BrowserBuffer
sig.signature(); // $ExpectType BrowserBuffer
...
StellarSdk.Memo.text('asdf').value; // $ExpectType string | BrowserBuffer
StellarSdk.Memo.return('asdf').value; // $ExpectType BrowserBuffer
StellarSdk.Memo.hash('asdf').value; // $ExpectType BrowserBuffer
...
feeBumptransaction.hash(); // $ExpectType BrowserBuffer
...
const newSignerXDR2 = StellarSdk.Operation.setOptions({
  signer: { sha256Hash: BrowserBuffer.from(''), weight: '1' }
});
...
op.trustor().ed25519(); // $ExpectType BrowserBuffer
...
a.homeDomain(); // $ExpectType string | BrowserBuffer
...
StellarSdk.xdr.Int32.toXDR(-1); // $ExpectType BrowserBuffer
StellarSdk.xdr.Uint32.toXDR(1); // $ExpectType BrowserBuffer
StellarSdk.xdr.String32.toXDR("hellow world"); // $ExpectedType BrowserBuffer
StellarSdk.xdr.Hash.toXDR(BrowserBuffer.alloc(32)); // $ExpectedType BrowserBuffer
StellarSdk.xdr.Signature.toXDR(BrowserBuffer.alloc(9, 'a')); // $ExpectedType BrowserBuffer
...
const raw = StellarSdk.xdr.LedgerEntryChanges.toXDR([change]); // $ExpectType BrowserBuffer
...
const pubkey = masterKey.rawPublicKey(); // $ExpectType BrowserBuffer
const seckey = masterKey.rawSecretKey(); // $ExpectType BrowserBuffer
const muxed = StellarSdk.encodeMuxedAccount(masterKey.publicKey(), '1'); // $ExpectType MuxedAccount
const muxkey = muxed.toXDR("raw"); // $ExpectType BrowserBuffer

let result = StellarSdk.StrKey.encodeEd25519PublicKey(pubkey);  // $ExpectType string
StellarSdk.StrKey.decodeEd25519PublicKey(result);               // $ExpectType BrowserBuffer
...
StellarSdk.StrKey.decodeEd25519SecretSeed(result);          // $ExpectType BrowserBuffer
...
StellarSdk.StrKey.decodeMed25519PublicKey(result);            // $ExpectType BrowserBuffer
...
StellarSdk.StrKey.decodeSignedPayload(result);            // $ExpectType BrowserBuffer
