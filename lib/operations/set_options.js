...
function setOptions(opts) {
  ...
  if (opts.signer) {
    ...
    if (opts.signer.preAuthTx) {
      ...
      if (!(_BrowserBuffer["default"].isBuffer(opts.signer.preAuthTx) && opts.signer.preAuthTx.length === 32)) {
    ...
    if (opts.signer.sha256Hash) {
      ...
      if (!(_BrowserBuffer["default"].isBuffer(opts.signer.sha256Hash) && opts.signer.sha256Hash.length === 32)) {
